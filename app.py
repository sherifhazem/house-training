...
if not st.session_state['logged_in']:
    ...
    try:
        ...
        st.error("يرجى التأكد من وضع رابط Google Sheet الصحيح في الكود.")
        st.info("تأكد أن إعدادات المشاركة في الشيت هي: 'Anyone with the link can view'")
        st.stop()
